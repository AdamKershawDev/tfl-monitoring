...
# 
# ### Purpose:
# This notebook performs the ingestion of liness data from the TFL Unified API into the bronze lakehouse. The JSON response from the API is landed into the **Files/tfl_monitoring/lines**. 
# 
# ### Process:
...
url = f"https://api.tfl.gov.uk/Line/Mode/tube?app_key={api_key}"
print(url)
