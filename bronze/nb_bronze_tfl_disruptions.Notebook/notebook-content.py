...
# # Notebook: nb_bronze_tfl_disruptions
# 
# ### Purpose:
# This notebook performs the ingestion of disruptions data from the TFL Unified API into the bronze lakehouse. The JSON response from the API is landed into the **Files/tfl_monitoring/disruptions**. 
# 
# ### Process:
...
url = f"https://api.tfl.gov.uk/Line/Mode/tube/Disruption?app_key={api_key}"
print(url)
